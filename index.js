...
// // Root route
// app.get("/", (req, res) => {
//   res.send("Car Doctor server is running on Vercel!");
// });
...
//   const serviceCollection = clientDB.db("carDoctor").collection("services");
...
//   const clientDB = await connectDB();
//   const bookingCollection = clientDB.db("carDoctor").collection("bookings");
